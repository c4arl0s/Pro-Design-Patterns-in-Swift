...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    var products = [
        ...
        Product(name: "Unsteady Chair", description: "Secretly give your opponent a disadvantage",
        ...
        Product(name: "Bling-Bling King", description: "Gold-plated, diamond-studded King",
                    ...
                    if let cell = currentCell as? ProductTableCell {
                        if let product = cell.product {
                            if let stepper = sender as? UIStepper {
                                ...
                                if let newStringValue = textField.text, let newValue = Int(newStringValue) {
